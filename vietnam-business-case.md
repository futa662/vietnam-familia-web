...
本計画書は、TERACOM（開発）、ARCHID（販売）、日本側技術パートナーが共同で推進するFamiliaのベトナム市場展開事業計画です。対象市場はベトナムのBMS市場（2033年に753億円規模）を中心に、IoT市場（1,650億円）、グリーンビル市場（12兆円）にまたがる成長分野です。

初期展開はHorison Tower（CBRE管理、ZEBHub認定プロジェクト）から開始し、CBREの管理物件200棟以上への横展開を計画しています。1棟あたりの導入費用は1,500万円、月額サービス費用は検討中です。
...
日本では成果報酬型（省エネ分配モデル）を採用していますが、ベトナムでは以下の収益モデルを検討しています：
...
### 具体的な収益シミュレーション（現実的シナリオ）

**1年目（2025年）: 実績作り**
- 導入数: 1-2棟（Horison Tower + α）
- 初期費用: 1,500万円 × 2棟 = 3,000万円
- 月額費用: 25万円 × 2棟 × 6ヶ月（平均） = 300万円
- **初年度売上: 3,300万円**

**2年目（2026年）: 信頼構築**
- 新規導入: 10棟
- 初期費用: 1,500万円 × 10棟 = 1億5,000万円
- 月額費用: 25万円 × 12棟（累計） × 12ヶ月 = 3,600万円
- **2年目売上: 1億8,600万円**

**3年目（2027年）: 本格展開**
- 新規導入: 30棟
- 初期費用: 1,500万円 × 30棟 = 4億5,000万円
- 月額費用: 25万円 × 42棟（累計） × 12ヶ月 = 1億2,600万円
- **3年目売上: 5億7,600万円**
...
1. **TERACOM（開発・実装）**: 
   ...
   - ベトナムIoT市場の急成長を背景に、省エネソリューションへの参入機会を検討
   - **注意点**: ソフトウェア開発には強いが、ハードウェア実装には別パートナーが必要
   - 現在、ハードウェア対応可能な協力企業を選定中

2. **ARCHID（営業・規制対応）**:
   - Son氏の強いリーダーシップと市場理解
   - ベトナム建築規制への深い理解
   - 現地デベロッパーとの強固なネットワーク
   - 「日本品質×ベトナム市場の成長性」という事業モデルを提案

各パートナーは、ベトナムのスマートビル市場が発展期にあることから、市場ポジションを確立できる時期と認識しています。
